    ...
    <button id="btn-message" className="button-message" type="button">
      ...
      <div className="notice-content">
        ...
        <div className="lable-message">
          Message
          <span className="number-message">3</span>
        </div>
    ...
    <main className="pvr-page">
      ...
      <section className="pvr-call-stage" id="videocall-stage">
        <div className="pvr-call-copy">
          ...
          <p>
            The videocall stage is the first thing inside. Start here, then move through the private
            files below.
          </p>
          <div className="pvr-call-actions">
            <button className="pvr-get-in" type="button">
              GET IN
            </button>
            <UpgradeButton />
            <MessageButton />
