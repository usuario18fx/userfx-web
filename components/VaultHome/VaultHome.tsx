      ...
      .then((data) => {
        if (data?.ok && data?.authenticated && isAccessPlanId(data.planId)) {
          ...
          setRemainingAccesses(
            Number.isFinite(Number(data.remainingAccesses)) ? Number(data.remainingAccesses) : null,
          );
        ...
        <div className="vx-grid">
          <div>
            ...
            <p className="vx-p vx-pNormal">
              ...
              <strong>USER🜲 FX —ᴘʀɪᴠᴀᴛᴇ ᴠᴀᴜʟᴛ—</strong> Is a reserved place. access is not public.
              You’ll need a ᴄᴏᴅᴇ
            </p>
      ...
      <section id="llaves" className="vx-sec vx-tint">
        <div className="vx-chooseZone">
          <Reveal>
            ...
            <h2>
              CHOOSE YOUR
              <span className="vx-codeTitle">CODE</span>
            </h2>
