...
type SmokelandiaAccessButtonProps = {
  onOpen: () => void;
  disabled?: boolean;
};
...
export function SmokelandiaAccessButton({
  ...
  return (
    <button
      ...
      aria-controls="smokelandia-access-modal"
    >
      ...
      <span className="smkl-access-button__content">
        <span className="smkl-access-button__title">ABRIR ACCESO</span>
        <span className="smkl-access-button__brand">SMOKELANDIA</span>
      </span>
