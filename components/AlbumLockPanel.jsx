...
function CrownSVG() {
  return (
    <svg viewBox="0 0 80 60" width="54" height="40" fill="none" className={styles.crownSvg}>
      <defs>
      ...
      {/* Rivets on band */}
      {[18, 32, 48, 62].map((x) => (
        <circle key={x} cx={x} cy="45" r="3" fill="#4a90d9" stroke="#a8d4ff" strokeWidth="0.8" />
      ))}
      {/* Crown spikes */}
      ...
      {/* Jewels on tips */}
      <circle cx="20" cy="11" r="4" fill="#a8d4ff" stroke="#ffffff" strokeWidth="0.8" opacity="0.9" />
      <circle cx="40" cy="5" r="5" fill="#7ec0ff" stroke="#ffffff" strokeWidth="1" opacity="0.95" />
      <circle cx="60" cy="11" r="4" fill="#a8d4ff" stroke="#ffffff" strokeWidth="0.8" opacity="0.9" />
      {/* Shine overlay */}
