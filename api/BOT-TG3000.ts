...
async function sendMembershipPanel(
  ctx: any
) {
  await typing(ctx);
  ...
  async (ctx) => {
    ...
    try {
      ...
      if (
        ...
        return await sendPendingVideocallPanel(
          ctx
        );
      }
